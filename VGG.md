...
### 通过堆叠多个3*3的卷积核来代替大尺度卷积核（减少参数）
如通过堆叠2个3*3卷积核代替5*5卷积核，堆叠3个3*3卷积核代替7*7卷积核
使用7*7的卷积核的参数，7*7*c*c = 39c<sup>2</sup>
使用3*3的卷积核的参数，3*3*c*c + 3*3*c*c + 3*3*c*c = 27c<sup>2</sup>
...
<img src = ".pic/VGG2.jpg">
<img src=".pic/VGG.png" >

+ conv层strid为1，padding为1
+ pooling层size为2，strid为2
